      ...
      <section className="container mx-auto px-4 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="space-y-4">
            <div className="relative overflow-hidden rounded-2xl shadow-lg bg-[#F3F4F6]">
              <img
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-4xl font-bold text-[#0B0B0B] mb-4 font-['Josefin_Sans']">
                {product.name}
              </h1>
            ...
            {product.categories?.name && (
              <div>
                ...
                <span className="inline-block px-4 py-2 bg-[#F3F4F6] text-gray-800 rounded-full text-sm font-medium">
                  {product.categories.name}
                </span>
              </div>
            )}
                ...
                <div className="flex flex-wrap gap-3">
                  {product.size_tags.map((size) => (
                    <button
                      ...
                      className={`px-6 py-3 rounded-full text-sm font-medium border-2 border-[#2D6A4F] transition-colors duration-200 ${
                        selectedSize === size
            ...
            <div className="flex items-center gap-6 pt-6 border-t border-gray-200">
              <div>
                ...
                <p className="text-4xl font-bold text-[#2D6A4F] font-['Poppins']">
                  ${product.price_base}
                </p>
              </div>
              <button

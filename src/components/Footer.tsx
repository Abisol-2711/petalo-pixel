      ...
      <div className="container mx-auto px-4 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              Diseños florales únicos que combinan la naturaleza con el arte
              digital
            </p>
          </div>

          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-[#2D6A4F] font-['Poppins']">
              Contacto
            </h3>
        ...
        <div className="pt-8 border-t border-gray-300 text-center">
          <p className="text-sm text-gray-500">
            © {new Date().getFullYear()} Pétalo & Pixel. Todos los derechos
            reservados.
          </p>
        </div>
      </div>
